...
class Test::Unit::TestCase
  def target_file
    File.expand_path(File.join(Dir.consistent_tmpdir, 'medusa_test.txt'))
  end
  
  def alternate_target_file
    File.expand_path(File.join(Dir.consistent_tmpdir, 'alternate_medusa_test.txt'))
  end
  ...
  def medusa_worker_init_file
    File.expand_path(File.join(File.dirname(__FILE__), 'fixtures', 'medusa_worker_init.rb'))
  end
