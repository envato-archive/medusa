  ...
  context "a pipe" do
    ...
    should "be able to write messages" do
      child = Process.fork do
        ...
        @pipe.write Medusa::Messages::TestMessage.new(:text => "Message Received")
        @pipe.write Medusa::Messages::TestMessage.new(:text => "Second Message")
      end
      @pipe.identify_as_parent
      @pipe.write Medusa::Messages::TestMessage.new(:text => "Test Message")
      ...
      assert_raise IOError do
        @pipe.write Medusa::Messages::TestMessage.new(:text => "anyone there?")
      end
    end
